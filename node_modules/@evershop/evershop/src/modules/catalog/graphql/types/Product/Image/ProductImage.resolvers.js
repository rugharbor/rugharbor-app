      ...
      return mainImage
        ? {
            ...
            // listing: product.listingImage || null,
              thumb: product.originImage || null,
            single: product.originImage || null,
            listing: product.originImage || null,
            alt: product.name,
            url: mainImage,
            uuid: uuidv4(),
            origin: mainImage
    ...
    gallery: async (product, _, { pool }) => {
      ...
      return gallery.map((image) => ({
        ...
        // listing: image.listing_image
          thumb: image.origin_image,
        single: image.origin_image,
        listing: image.origin_image
      }));
    }
  }
};
